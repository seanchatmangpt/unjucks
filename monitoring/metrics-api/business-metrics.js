...
class BusinessMetricsAPI {
  ...
  initializeRoutes() {
    ...
    this.app.get('/health', (req, res) => {
      res.json({ status: 'healthy', timestamp: this.getDeterministicDate().toISOString() });
    });
    ...
    this.app.post('/metrics/custom', (req, res) => {
      try {
        ...
        res.json({ success: true, timestamp: this.getDeterministicDate().toISOString() });
      } catch (error) {
