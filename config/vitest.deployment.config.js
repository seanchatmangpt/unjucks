...
export default defineConfig({
  test: {
    ...
    include: ['tests/deployment/**/*.test.js'], // Changed from .ts to .js
    exclude: [
      'node_modules',
      'dist',
      'examples',
    ...
    globalSetup: ['tests/deployment/global-setup.js'], // Changed from .ts to .js
    // globalTeardown: ['tests/deployment/global-teardown.js'], // Not supported in Vitest
    ...
    coverage: {
      ...
      include: ['tests/deployment/**/*.js'], // Changed from .ts to .js
      exclude: ['tests/deployment/**/*.steps.js'], // Changed from .ts to .js
    },
