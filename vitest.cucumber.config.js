...
export default defineConfig({
  test: {
    // BDD/Cucumber specific configuration for template filter testing
    include: [
      'tests/features/basic-filter-integration.test.js',
      'tests/features/simple-filters.test.js',
    ],
    exclude: [
      'tests/features/**/*.feature', // Exclude raw feature files
      'node_modules/**/*',
      'dist/**/*',
      'tests/.tmp/**/*' // Exclude temp test files
    ],
    globals: true,
    environment: 'node',
    ...
    // Cucumber-specific settings for filter testing
    setupFiles: ['./tests/setup/filter-test-setup.js'],
