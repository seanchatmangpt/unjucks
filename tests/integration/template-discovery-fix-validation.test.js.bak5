...
describe("Template Discovery Fix Validation", () => {
  ...
  it("should provide helpful error for missing template in valid generator", async () => {
    await expect(
      ...
      /Template 'nonexistent' not found in generator 'valid-generator'. Available templates);
  });
  ...
  it("should properly discover available templates", async () => {
    const availableTemplates = await (generator).getAvailableTemplates("valid-generator");
  ...
  it("should return empty array for empty generator", async () => {
    const availableTemplates = await (generator).getAvailableTemplates("empty-generator");
