...
describe('Error Handling and Validation', () => {
  ...
  describe('Generator Not Found Errors', () => {
    ...
    it('should suggest available generators when generator not found', async () => {
      // Create some generators first
    ...
    it('should handle empty _templates directory', async () => {
  ...
  describe('Malformed Template Errors', () => {
    beforeEach(async () => {
  ...
  describe('File System Permission Errors', () => {
    it('should handle read-only destination directories', async () => {
      await fs.mkdir('_templates/component', { recursive: true });
      await fs.writeFile(
        '_templates/component/new.tsx.njk',
        '---\nto: {{name}}.tsx\n---\nContent'
  ...
  describe('Memory and Resource Limits', () => {
    ...
    it('should handle deep directory nesting', async () => {
      const deepPath = 'a/'.repeat(100); // Very deep nesting
  ...
  describe('Configuration Errors', () => {
    ...
    it('should handle missing configuration dependencies', async () => {
      await fs.writeFile(
        'unjucks.config.js',
        'module.exports = { templateEngine: "nonexistent-engine" };'
      );
  ...
  describe('Recovery and Cleanup', () => {
    ...
    it('should preserve existing files on generation failure', async () => {
      await fs.mkdir('_templates/preserve', { recursive: true });
      await fs.writeFile(
