...
describe('Configuration Loader', () => {
  ...
  it('should handle environment variable overrides', () => {
    ...
    try {
      ...
      const finalConfig = {
        ...baseConfig,
        templatesDir: process.env.UNJUCKS_TEMPLATES_DIR || baseConfig.templatesDir,
        outputDir: process.env.UNJUCKS_OUTPUT_DIR || baseConfig.outputDir,
        debug: process.env.UNJUCKS_DEBUG === 'true' || baseConfig.debug
      };
