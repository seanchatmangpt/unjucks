...
import { cleanup } from '../step-definitions/mcp-tools-steps.js';
...
describeFeature(feature, ({ Scenario }) => {
  ...
  Scenario('unjucks_generate Tool Real Operation', ({ Given, When, Then }) => { Given('I have a clean test environment with templates');
    Given('the MCP server is running');
    Given('I have a "component/react" template');
