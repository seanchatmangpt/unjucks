...
import positionalParametersSteps from '../step-definitions/positional-parameters.steps.js';
...
defineFeature(feature, (test) => {
  ...
  test('Basic positional parameter syntax works like Hygen', ({ given, when, then, and }) => {
    ...
    given('I create a basic component generator with template', async () => {
      await positionalParametersSteps['I create a basic component generator with template'](world);
    });
  ...
  test('Positional parameters combined with flags', ({ given, when, then, and }) => { given('I set up a temporary test environment', setupWorld);

    given('I create a basic component generator with template });
    ...
    and('the file content should contain "testId?, async () => {
      await positionalParametersSteps['the file content should contain {string}'](world, 'testId?);
    });
  ...
  test('Multiple positional parameters with smart type inference', ({ given, when, then, and }) => { given('I set up a temporary test environment', setupWorld);

    given('I create a generator "api/endpoint" with template } with template:'](world, 'api/endpoint', templateContent);
    });
    ...
    and('the file content should contain "baseUrl, async () => {
      await positionalParametersSteps['the file content should contain {string}'](world, 'baseUrl);
    });

    and('the file content should contain "version, async () => {
      await positionalParametersSteps['the file content should contain {string}'](world, 'version);
    });

    and('the file content should contain "authenticated, async () => {
      await positionalParametersSteps['the file content should contain {string}'](world, 'authenticated);
    });

    cleanupWorld();
  });

  test('Backward compatibility with flag-based syntax', ({ given, when, then, and }) => { given('I set up a temporary test environment', setupWorld);
  ...
  test('Smart type inference for positional arguments', ({ given, when, then, and }) => { given('I set up a temporary test environment', setupWorld);

    given('I create a generator "config/settings" with template } with template:'](world, 'config/settings', templateContent);
    });
    ...
    and('the file content should contain \'"port", async () => {
      await positionalParametersSteps['the file content should contain {string}'](world, '"port");
    });

    and('the file content should contain \'"debug", async () => {
      await positionalParametersSteps['the file content should contain {string}'](world, '"debug");
    });

    and('the file content should contain \'"apiKey", async () => {
      await positionalParametersSteps['the file content should contain {string}'](world, '"apiKey");
    });
