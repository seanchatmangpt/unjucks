...
import advancedFrontmatterSteps from '../step-definitions/advanced-frontmatter.steps';
...
defineFeature(feature, (test) => {
  ...
  test('Basic Hygen frontmatter compatibility', ({ given, when, then, and }) => {
    ...
    given('I create a template with standard Hygen frontmatter:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with standard Hygen frontmatter:'](world, templateContent);
    });
  ...
  test('Unjucks-exclusive frontmatter features', ({ given, when, then, and }) => {
    ...
    given('I create a template with enhanced frontmatter:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with enhanced frontmatter:'](world, templateContent);
    });
  ...
  test('All injection mode variations - after mode', ({ given, when, then, and }) => {
    ...
    given('I create a base file "src/registry.ts" with content:', async (content: string) => {
      await advancedFrontmatterSteps['I create a base file {string} with content:'](world, 'src/registry.ts', content);
    });

    and('I create a template with injection mode "after":', async (templateContent: string) => {
  ...
  test('Advanced conditional frontmatter logic', ({ given, when, then }) => {
    ...
    given('I create a template with complex skipIf conditions:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with complex skipIf conditions:'](world, templateContent);
    });

    when('I test various skip conditions:', async (dataTable: any) => {
      await advancedFrontmatterSteps['I test various skip conditions:'](world, dataTable);
    });
  ...
  test('Dynamic path generation with complex expressions', ({ given, when, then, and }) => {
    ...
    given('I create a template with dynamic path calculation:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with dynamic path calculation:'](world, templateContent);
    });

    when('I generate files with different types:', async (dataTable: any) => {
      await advancedFrontmatterSteps['I generate files with different types:'](world, dataTable);
    });

    then('files should be created at correct dynamic paths', async (dataTable: any) => {
  ...
  test('Advanced shell command execution', ({ given, when, then, and }) => {
    ...
    given('I create a template with complex shell commands:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with complex shell commands:'](world, templateContent);
    });
  ...
  test('File permissions and modes', ({ given, when, then }) => {
    ...
    given('I create templates with various chmod settings:', async (dataTable: any) => {
      await advancedFrontmatterSteps['I create templates with various chmod settings:'](world, dataTable);
    });
  ...
  test('YAML frontmatter validation and error handling', ({ given, when, then, and }) => {
    ...
    given('I create a template with invalid YAML frontmatter:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with invalid YAML frontmatter:'](world, templateContent);
    });
  ...
  test('Complex nested YAML structures in frontmatter', ({ given, when, then, and }) => {
    ...
    given('I create a template with nested YAML configuration:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with nested YAML configuration:'](world, templateContent);
    });
  ...
  test('Variable interpolation in frontmatter values', ({ given, when, then, and }) => {
    ...
    given('I create a template with interpolated frontmatter:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with interpolated frontmatter:'](world, templateContent);
    });

    when('I run with variables:', async (dataTable: any) => {
      await advancedFrontmatterSteps['I run with variables:'](world, dataTable);
    });
  ...
  test('Conditional frontmatter properties', ({ given, when, then, and }) => {
    ...
    given('I create a template with conditional frontmatter:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with conditional frontmatter:'](world, templateContent);
    });

    when('I run with different flag combinations:', async (dataTable: any) => {
      await advancedFrontmatterSteps['I run with different flag combinations:'](world, dataTable);
    });
  ...
  test('Idempotent injection operations', ({ given, when, then, and }) => {
    ...
    given('I have an existing file "src/exports.ts":', async (content: string) => {
      await advancedFrontmatterSteps['I have an existing file {string}:'](world, 'src/exports.ts', content);
    });

    and('I create a template with idempotent injection:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template with idempotent injection:'](world, templateContent);
    });
  ...
  test('Frontmatter error recovery and rollback', ({ given, when, then, and }) => {
    ...
    given('I create a template that might fail during processing:', async (templateContent: string) => {
      await advancedFrontmatterSteps['I create a template that might fail during processing:'](world, templateContent);
    });
