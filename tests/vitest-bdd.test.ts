...
describe('Enhanced CLI Commands - BDD Test Suite', () => {
  ...
  describe('Feature: Enhanced CLI Commands', () => {
    ...
    describe('Scenario: Initialize AI swarm with mesh topology', () => {
    ...
    describe('Scenario: Monitor swarm status and performance', () => {
      it('Given I have an active swarm', async () => {
      ...
      it('When I run "unjucks swarm status --detailed"', async () => {
  ...
  it('should store BDD setup information in memory', async () => {
    const setupInfo = {
      framework: '@amiceli/vitest-cucumber',
      testSuites: 6,
      scenarios: 6,
      stepDefinitions: 25,
