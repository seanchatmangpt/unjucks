 ...
 * @property {keyof typeof DocumentType} type - Document type
 * @property {keyof typeof VariableSyntax} [syntax] - Variable syntax to use
 * @property {keyof typeof ProcessingMode} [mode] - Processing mode
 * @property {TemplateVariable[]} [variables] - Template variables
 * @property {InjectionPoint[]} [injectionPoints] - Injection points
 * @property {Record<string, any>} [metadata] - Template metadata
 ...
 * @property {any} [schema] - Schema validation
 */
 ...
 * @property {function(any, ProcessingContext): ValidationResult} fn - Function implementation
 ...
 * @property {Record<string, any>} data - Input data
 * @property {ProcessingOptions} options - Processing options
 * @property {any} [document] - Current document state
 ...
 * @property {string} name - Template name
 * @property {keyof typeof DocumentType} type - Template type
 ...
 * @property {Record<string, any>} [processors] - Custom processors
 */
 ...
 * @property {keyof typeof ErrorSeverity} severity - Error severity
 ...
 * @property {DocumentMetadata} [metadata] - Metadata about the processed document
 */
 ...
 * @property {Record<string, any>} [properties] - Document properties
 */
 ...
 * @property {Record<string, any>[]} data - Input data for each template
 ...
 * @property {function(BatchProgress): void} [onProgress] - Progress callback
 */
 ...
 * @property {Array<keyof typeof DocumentType>} supportedTypes - Supported document types
 * @property {function(PluginContext): Promise<void>} [initialize] - Plugin initialization
 * @property {function(ProcessingContext): Promise<ProcessingResult>} [process] - Process hook
 * @property {function(ProcessingContext): Promise<ValidationResult>} [validate] - Validation hook
 * @property {function(): Promise<void>} [cleanup] - Cleanup hook
 */

/**
 * Plugin context
 * @typedef {Object} PluginContext
 * @property {Record<string, any>} config - Plugin configuration
 * @property {any} logger - Logger instance
 * @property {Record<string, any>} utils - Utility functions
 */
 ...
 * @property {Record<keyof typeof DocumentType, number>} typeDistribution - File types distribution
 */