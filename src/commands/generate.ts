...
import type { GenerateCommandArgs, CommandResult, CommandError, UnjucksCommandError } from "../types/commands.js";
import ora from "ora";
 ...
 * ```
 */
export const generateCommand = defineCommand<GenerateCommandArgs>({
  meta: {
    name: "generate",
  ...
  async run({ args }: { args: GenerateCommandArgs }) {
