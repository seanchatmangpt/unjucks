 ...
 * @property {string} postgres.host
 * @property {number} postgres.port
 * @property {string} postgres.database
 * @property {string} postgres.user
 * @property {string} postgres.password
 ...
 * @property {Object} jwt
 * @property {string} jwt.secret
 * @property {string} jwt.expiresIn
 * @property {string} jwt.refreshExpiresIn
