...
import type { ToolResult, UnjucksDryRunParams } from '../types.js';
import { 
 ...
 */
export async function unjucksDryRun(params: UnjucksDryRunParams): Promise<ToolResult> {
 ...
 */
function generateRecommendations(files: any[], summary: any): string[] {
 ...
 */
function formatDryRunReport(report: any): string {
  const lines = [];
