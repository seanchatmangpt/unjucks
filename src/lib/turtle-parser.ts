...
import type {
  TurtleParseResult as UnifiedTurtleParseResult,
  TurtleParseOptions as UnifiedTurtleParseOptions,
  ParsedTriple as UnifiedParsedTriple,
