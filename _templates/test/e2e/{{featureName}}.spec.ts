...
import { loginUser, createTestUser } from '../helpers/auth-helpers'
{%- endif %}
{%- if hasDataPersistence %}
import { seedTestData, cleanupTestData } from '../helpers/db-helpers'
{%- endif %}

test.describe('{{ featureName | titleCase }} Feature', () => {
  let page: Page
  ...
  test('should handle real-time updates', async () => {
    ...
    await expect(secondPage.locator('[data-testid="realtime-content"]'))
      .toContainText('Real-time test', { timeout: 5000 })
